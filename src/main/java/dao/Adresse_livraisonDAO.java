...
public class Adresse_livraisonDAO {
	...
	public void save(Adresse_livraison obj) {
		...
		try {
			...
			if(obj.getId() != 0) {
				PreparedStatement preparedStatement  = Database.connexion.prepareStatement("UPDATE adresses_livraison fk_user=?, adresse=?, cp=?, ville=?, pays=?, archiver=? WHERE id=?");
...
//				preparedStatement.setDate(3, d);
				...
				PreparedStatement preparedStatement  = Database.connexion.prepareStatement("INSERT INTO adresses_livraison (fk_user, adresse, cp, ville, pays, archiver) VALUES(?,?,?,?,?,?)");
				preparedStatement.setInt(1,obj.getFk_user());
				preparedStatement.setString(2,obj.getAdresse());
				preparedStatement.setString(3, obj.getCp());
				preparedStatement.setString(4,obj.getVille());
...
//				preparedStatement.setDate(3, d);
	...
	public int saveAndReturnGeneratedId(Adresse_livraison obj) {
		...
		try {
			...
			if(obj.getId() != 0) {
				PreparedStatement preparedStatement  = Database.connexion.prepareStatement("UPDATE adresses_livraison set fk_utilisateur=?, date=?, total=?, fk_adresse=?, etat=?, archiver=? WHERE id=?");
				preparedStatement.setInt(1,obj.getFk_user());
				preparedStatement.setString(2,obj.getAdresse());
				preparedStatement.setString(3, obj.getCp());
				preparedStatement.setString(4,obj.getVille());
...
//				preparedStatement.setDate(3, d);
				...
				PreparedStatement preparedStatement  = Database.connexion.prepareStatement("INSERT INTO adresses_livraison (idClient, dateCommande, totalCommande) VALUES(?,?,?,?,?,?)", PreparedStatement.RETURN_GENERATED_KEYS);
				preparedStatement.setInt(1,obj.getFk_user());
				preparedStatement.setString(2,obj.getAdresse());
				preparedStatement.setString(3, obj.getCp());
				preparedStatement.setString(4,obj.getVille());
...
public Adresse_livraison getById(int id) {
	try {
			...
			PreparedStatement preparedStatement  = Database.connexion.prepareStatement("SELECT * FROM adresses_livraison WHERE id=?");
...
public ArrayList<Adresse_livraison> getAll() {
	...
	try {
			...
			PreparedStatement preparedStatement  = Database.connexion.prepareStatement("SELECT * FROM adresses_livraison");
...
public ArrayList<Adresse_livraison> getAllByClient(int idClient) {
	...
	try {
			...
			PreparedStatement preparedStatement  = Database.connexion.prepareStatement("SELECT * FROM adresses_livraison WHERE fk_user=?");
...
public void archiveById(Adresse_livraison c) {
	try {
			...
			PreparedStatement preparedStatement  = Database.connexion.prepareStatement("UPDATE adresses_livraison set archiver=? WHERE id=?");
...
public int countTotalAdresses() {
	...
	try {
			...
			PreparedStatement preparedStatement  = Database.connexion.prepareStatement("SELECT count(*) FROM adresses_livraison;");
...
public void deleteById(int id) {
	try {
			...
			PreparedStatement preparedStatement  = Database.connexion.prepareStatement("DELETE FROM adresses_livraison WHERE id=?");
			preparedStatement.setInt(1, id);
