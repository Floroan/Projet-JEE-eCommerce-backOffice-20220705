...
public class VisiteDAO {
	...
	try {
			...
			PreparedStatement preparedStatement  = Database.connexion.prepareStatement("INSERT INTO visites (fk_prod, fk_user, date) VALUES(?,?,?)");
...
try {
		...
		PreparedStatement preparedStatement  = Database.connexion.prepareStatement("SELECT * FROM visites WHERE idProduit=? AND idClient=?");
...
try {
		...
		PreparedStatement preparedStatement  = Database.connexion.prepareStatement("DELETE FROM visites WHERE idProduit=? AND idClient=?");
...
try {
		...
		PreparedStatement preparedStatement  = Database.connexion.prepareStatement("DELETE FROM visites WHERE idProduit=?");
		preparedStatement.setInt(1,idProduit);
