...
public class HashMe {
	...
	public String sha1(String input) {
		...
		System.out.println("Password before hash : " + input);
		...
		try {
			...
			System.out.println("HashMe from Package tools.HashMe.java : " + sha1);
			System.out.println("Password : 11aaAA@@ -> hcxTphhoBsVOBdYWBvFSQw==");
