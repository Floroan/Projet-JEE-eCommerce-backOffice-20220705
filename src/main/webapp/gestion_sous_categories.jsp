...
<head>
  ...
  <title>Hytek gestion des sous catégories</title>
</head>
              ...
              <div class="ps-3">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Gestion des Sous Categories</li>
                  </ol>
                </nav>
              </div>
            </div>
            <!--end breadcrumb-->
              ...
              <div class="card">
                <div class="card-header py-3">
                  <h6 class="mb-0">Ajouter une sous catégorie</h6>
                </div>
                <div class="card-body">
                   <div class="row">
                         ...
                         <div class="card-body">
                           <form class="row g-3" method="post">
                             <div class="col-12">
                               ...
                               <input name="ajoutTitre" type="text" class="form-control" placeholder="Category name" required>
                             </div>
                             <div class="col-12">
                              <label class="form-label">Archiver</label>
                              <input name="ajoutArchive" type="number" min="0" max="1" class="form-control" placeholder="0" required>
                            </div>
                            <div class="col-12">
                              <label class="form-label">Catégorie mère</label>
                              <select class="form-select" name="associerCat" required>
                              <option selected disabled value="">Associer une à catégorie...</option>
                            ...
                            <div class="col-12">
                              <div class="d-grid">
                                <button name="ajoutSsCat" class="btn btn-primary" type="submit">Ajouter</button>
                              </div>
                            </div>
                           </form>
                         </div>
                                 ...
                                 <form method="post" action="GestionSousCategorie">
                                   ...
                                   <td><%= "actuelle: " + sc.getFk_categorie() + " - " + sc.getC().getTitre() %>
		                              <select class="form-select" name="changerCat">
				                            ...
				                            <%for(Categorie c : cats){ %>
				                            <option value="<%=c.getId() %>"><%= c.getId() + ", "  + c.getTitre() %></option>
				                            <%} %>
		                              </select>   
                                   </td>
