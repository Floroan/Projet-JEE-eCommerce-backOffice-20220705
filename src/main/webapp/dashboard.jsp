						...
						<div class="card-body">
							<div class="d-flex align-items-stretch justify-content-between overflow-hidden">
								...
								<div class="w-50">
									...
									%>
									<p class="mb-3 float-end text-warning">
										+ ${cmdsA24h }%<i class="bi bi-arrow-down"></i>
									</p>
									<%
									} else {
									%>
									<p class="mb-3 float-end text-success">
										+ ${cmdsA24h }%<i class="bi bi-arrow-up"></i>
									</p>
									<%
									}
									%>
						...
						<div class="card-body">
							<div
								...
								<div class="w-50">
									...
									%>
									<p class="mb-3 float-end text-danger"><%=mod%>%<i
			...
			<!--end row-->
				...
				<div class="row">
					<div class="col-12 col-lg-6">
						<h6 class="mb-0 text-uppercase">Toutes les commandes</h6>
						<hr/>
						<div class="card">
							<div class="card-body">
								<form method="post">
									<label for="validationCustom01" class="form-label">depuis les </label>
									<select name="lastCmdsInterval">
										<option>7</option>
										<option>15</option>
										<option>30</option>
									...
									<div id="chart90"></div>
									<div class="d-grid">
										<button type="submit" class="btn btn-primary" name="lastCmds">Afficher la courbe</button>
				                    </div>
								</form>
							</div>
						</div>
...
<script>
	...
	chart.render();
					...
					<div class="col-12 col-lg-6">
						<h6 class="mb-0 text-uppercase">nombre de Produits par catégorie</h6>
		                <hr/>
		                <div class="card">
		                	<div class="card-body">
								<div id="chart88" class="col"></div>
							</div>
						</div>
					</div>
				</div>
<script>
	...
	chart.render()
						...
						<div class="row">
							<div class="col-12 col-lg-6">
								<h6 class="mb-0 text-uppercase">Les 5 mots-clés les plus recherchés</h6>
								<hr/>
								<div class="card">
									<div class="card-body">
										<div id="chart89" class="col"></div>
										<form method="post" action="TopRecherches">
											<div class="d-grid">
												<button class="btn btn-primary" type="submit">Afficher le tableau</button>
		                    				</div>
										</form>
									</div>
								</div>
  ...
  plotOptions: {
	...
	chart.render()
				...
				<!--         </div> -->
							...
							<div class="col-12 col-lg-6">
								<h6 class="mb-0 text-uppercase">Visites par produit</h6>
								<hr/>
								<div class="card">
									<div class="card-body">
													...
													<div class="">
														<ul class="list-group list-group-flush">
															...
															<li class="list-group-item d-flex align-items-center justify-content-between border-0">
																...
																<img src="<%=entry.getKey().getImage()%>" height="50px" width="50px" /> 
																<%
																if (entry.getKey().getTitre().length() > 8) {
																%> 
																<span><%=entry.getKey().getTitre().substring(0, 8)%></span> <span><%=entry.getValue() * 100 / ttl%>%</span>
																<%
																} else {
																%> 
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center gap-3 cursor-pointer">
														<a href="FicheProduit?id=<%=p.getId()%>"
															title="Voir informations & statistiques"> <img
															src="<%=p.getImage()%>" class="rounded-circle"
												...
												<td>
													<div class="d-flex align-items-center gap-3 fs-6">
														<a href="DetailProduit?id=<%=p.getId()%>"
															class="text-primary" data-bs-toggle="tooltip"
															data-bs-placement="bottom" title=""
															data-bs-original-title="View detail" aria-label="Views"><i
															class="bi bi-eye-fill"></i></a> <a
															href="DetailProduit?id=<%=p.getId()%>"
															class="text-warning" data-bs-toggle="tooltip"
															data-bs-placement="bottom" title=""
															data-bs-original-title="Editer le stock"
									...
									<table class="table align-middle mb-0">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<div class="d-flex align-items-center gap-3 fs-6">
														<a href="DetailCommande?id=<%=cmd.getId()%>"
															class="text-primary" data-bs-toggle="tooltip"
															data-bs-placement="bottom" title=""
															data-bs-original-title="View detail" aria-label="Views"><i
															class="bi bi-eye-fill"></i></a> <a href="javascript:;"
															class="text-warning" data-bs-toggle="tooltip"
															data-bs-placement="bottom" title=""
				...
				<div class="offcanvas-body">
					...
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio"
							name="inlineRadioOptions" id="LightTheme" value="option1" checked>
