  ...
  <!--start wrapper-->
	<div class="wrapper">
		...
		<main class="page-content">
			<h1 class="mb-0 text-uppercase text-center">courbes utilisateurs front office</h6>
			<hr/>			
			<h6 class="mb-0 text-uppercase">Courbes...</h6>
			<hr/>
			<div class="card">
				<div class="card-body">
					<div class="row">
						<div class="col-12 col-lg-3">
							<form method="post">
								<label for="validationCustom01" class="form-label">Choisir une catégorie</label>
								<select id="validationCustom01" class="form-select mb-3" aria-label="Default select example" name="selectedTable" required>
							<% 
		...
		<!-- 					<input type="text" class="form-control datepicker picker__input" readonly=""  name="dt2" id="P1926380751" aria-haspopup="true" aria-readonly="false" aria-owns="P1926380751_root"> -->
								...
								<!-- <div class="col-md-4">
									...
									<div class="col-md-4">
										<label>Début</label>
										<input type="date" name="dt1" placehoder="début" class="form-control" required>
										<label>Fin:</label>
										<input type="date" name="dt2" placehoder="fin" class="form-control" required>
									</div>
									<button type="submit" name="topOf" class="btn btn-outline-primary px-5">Afficher</button>
								</div> -->
								<div class="col-12 mb-4">
									<div class="d-grid">
										<button type="submit" class="btn btn-primary" name="topOf">Afficher la courbe</button>
				                    </div>
				                </div>
							</form>
							<form method="post">
								<div class="col-12">
									<div class="d-grid">
										<button type="submit" class="btn btn-warning" name="retourDash">Retour au Dashboard</button>
									</div>
								</div>
							</form>
						</div>
