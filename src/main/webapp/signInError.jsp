                ...
                <div class="col-lg-6">
                  <div class="card-body p-4 p-sm-5">
					...
					<div class="alert alert-danger text-center" role="alert">
						<h5 class="card-title">${authError }</h5>
					</div>
					<%
						}
					}
                    ...
                    <form class="form-body">
                        <div class="row g-3">
                          <div class="col-12">
                            ...
                            <input type="email" class="form-control form-control-lg radius-30" id="inputEmailid" placeholder="">
                          </div>
                          <div class="col-12">
                            <div class="d-grid gap-3">
                              <button type="submit" class="btn btn-lg btn-primary radius-30">Envoyer</button>
